...
Metropolis is a simple, modern beamer theme that focuses on removing unnecessary componenets
...
1. **Download the source** with a `git clone` of the [Metropolis repository](https://github.com/AbsoluteStratos/mtheme) or as a [zip archive](https://github.com/matze/mtheme/archive/master.zip) of the latest development version.
